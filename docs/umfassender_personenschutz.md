...
**Verfügbarkeit:** Das Rettungsdatenblatt wird im Fahrzeug mitgeführt (z.B. hinter der Sonnenblende) und kann direkt über den Link <a href="https://fhiel.github.io/x19e-electric-speed/safety/Rettungskarte_Bertone_X19e.pdf" target="_blank"><em>Rettungskarte Bertone X1/9e</em></a> oder diesen QR-Code abgerufen werden.

<figure id="qrcode1">
  <img src="../Pictures/10038B520000E0B00000E0B004383720.svg">
  <figcaption style="text-align: center;">Abbildung 1: QR-Code zum Rettungsdatenblatt</figcaption>
</figure>
